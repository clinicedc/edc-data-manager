        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reference_model",
                    models.CharField(
                        default="ambition_subject.subjectrequisition",
                        editable=False,
                        max_length=150,
                        null=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auto_reference",
                    models.CharField(
                        max_length=150, null=True, verbose_name="Query rule reference"
                    ),
                ),
                ("history_date", models.DateTimeField()),
                ("history_change_reason", models.CharField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reference_model",
                    models.CharField(
                        default="ambition_subject.subjectvisit",
                        editable=False,
                        max_length=150,
                        null=True,
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="select all that apply",
                        related_name="_requisitionqueryrule_visit_schedule_+",
                        to="edc_data_manager.QueryVisitSchedule",
                        verbose_name="Visit",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="select all that apply",
                        related_name="_requisitionqueryrule_visit_schedule_exclude_+",
                        to="edc_data_manager.QueryVisitSchedule",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="select all that apply",
                        related_name="_requisitionqueryrule_data_dictionaries_+",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="select all that apply",
                        related_name="_crfqueryrule_visit_schedule_+",
                        to="edc_data_manager.QueryVisitSchedule",
                        verbose_name="Visit",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="select all that apply",
                        related_name="_crfqueryrule_visit_schedule_exclude_+",
                        to="edc_data_manager.QueryVisitSchedule",
                        verbose_name="Visit (exclude)",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="select all that apply",
                        related_name="_crfqueryrule_data_dictionaries_+",
                        to="edc_data_manager.CrfDataDictionary",
                        verbose_name="Question(s)",
                    ),
                ),
