# Generated by Django 2.2.2 on 2019-06-24 00:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='HistoricalRequisitionQueryRule',
            fields=[
                ('revision', django_revision.revision_field.RevisionField(blank=True, editable=False, help_text='System field. Git repository tag:branch:commit.', max_length=75, null=True, verbose_name='Revision')),
                ('created', models.DateTimeField(blank=True, default=django_audit_fields.models.audit_model_mixin.utcnow)),
                ('modified', models.DateTimeField(blank=True, default=django_audit_fields.models.audit_model_mixin.utcnow)),
                ...
                ('query_text', models.TextField(blank=True, help_text='Generic query text for auto-generated queries.', null=True)),
                ('timing', models.IntegerField(default=48, verbose_name='Timing')),
                ('timing_units', models.CharField(choices=[('hours', 'Hours'), ('days', 'Days'), ('weeks', 'Weeks'), ('months', 'Months')], default='hours', max_length=25, verbose_name='Units')),
                ('query_priority', models.CharField(choices=[('high', 'High'), ('NORMAL', 'Normal')], default='NORMAL', max_length=25, verbose_name='Priority')),
                ('comment', models.TextField(blank=True, null=True)),
                ('reference_date', models.CharField(choices=[('report_datetime', 'Report datetime (visit report)'), ('drawn_datetime', 'Specimen draw date (requisition)')], default='report_datetime', editable=False, max_length=25)),
                ('reference_model', models.CharField(default='ambition_subject.subjectrequisition', editable=False, max_length=150, null=True)),
                ('history_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('requisition_panel', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_data_manager.RequisitionPanel', verbose_name='Panel')),
                ('sender', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_data_manager.DataManagerUser', verbose_name='Query raised by')),
            ...
            options={
                'verbose_name': 'historical requisition query rule',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('query_priority', models.CharField(choices=[('high', 'High'), ('NORMAL', 'Normal')], default='NORMAL', max_length=25, verbose_name='Priority')),
                ('visit_code_sequence', models.IntegerField(default=0, help_text="Defaults to '0'. For example, when combined with the visit code `1000` would make `1000.0`.", validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(25)], verbose_name='Visit code sequence')),
                ...
                ('auto_generated', models.BooleanField(default=False, help_text='This query was auto-generated by a query rule.')),
                ('auto_reference', models.CharField(max_length=150, null=True, verbose_name='Query rule reference')),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ...
                ('requisition_panel', models.ForeignKey(blank=True, db_constraint=False, help_text='Requisition will be expected on day of visit.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_data_manager.RequisitionPanel', verbose_name='Are responses linked to a requisition? If so, which')),
                ...
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.Site')),
                ('tcc_user', models.ForeignKey(blank=True, db_constraint=False, help_text='select a name from the list', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_data_manager.DataManagerUser', verbose_name='TCC resolved by')),
                ('visit_schedule', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_data_manager.QueryVisitSchedule', verbose_name='Visit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('query_priority', models.CharField(choices=[('high', 'High'), ('NORMAL', 'Normal')], default='NORMAL', max_length=25, verbose_name='Priority')),
                ('comment', models.TextField(blank=True, null=True)),
                ('reference_date', models.CharField(choices=[('report_datetime', 'Report datetime (visit report)'), ('drawn_datetime', 'Specimen draw date (requisition)')], default='report_datetime', max_length=25)),
                ('reference_model', models.CharField(default='ambition_subject.subjectvisit', editable=False, max_length=150, null=True)),
                ('history_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
            ...
            options={
                'verbose_name': 'historical crf query rule',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_date', models.CharField(choices=[('report_datetime', 'Report datetime (visit report)'), ('drawn_datetime', 'Specimen draw date (requisition)')], default='report_datetime', editable=False, max_length=25)),
                ('reference_model', models.CharField(default='ambition_subject.subjectrequisition', editable=False, max_length=150, null=True)),
                ('recipients', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_requisitionqueryrule_recipients_+', to='edc_data_manager.QueryUser', verbose_name='Send to')),
                ('requisition_panel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_data_manager.RequisitionPanel', verbose_name='Panel')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_data_manager.DataManagerUser', verbose_name='Query raised by')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
                ('visit_schedule', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_requisitionqueryrule_visit_schedule_+', to='edc_data_manager.QueryVisitSchedule', verbose_name='Visit')),
                ('visit_schedule_exclude', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_requisitionqueryrule_visit_schedule_exclude_+', to='edc_data_manager.QueryVisitSchedule', verbose_name='Visit (exclude)')),
                ('data_dictionaries', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_requisitionqueryrule_data_dictionaries_+', to='edc_data_manager.CrfDataDictionary', verbose_name='Question(s)')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_dictionaries', models.ManyToManyField(blank=True, help_text='select all that apply', to='edc_data_manager.DataDictionary', verbose_name='CRF question(s)')),
                ...
                ('recipients', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_dataquery_recipients_+', to='edc_data_manager.QueryUser', verbose_name='Sent to')),
                ...
                ('requisition_panel', models.ForeignKey(blank=True, help_text='Requisition will be expected on day of visit.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_data_manager.RequisitionPanel', verbose_name='Are responses linked to a requisition? If so, which')),
                ('sender', models.ForeignKey(help_text='select a name from the list', on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_data_manager.DataManagerUser', verbose_name='Query raised by')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
                ('tcc_user', models.ForeignKey(blank=True, help_text='select a name from the list', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='tcc_user', to='edc_data_manager.DataManagerUser', verbose_name='TCC resolved by')),
                ('visit_schedule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_data_manager.QueryVisitSchedule', verbose_name='Visit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_date', models.CharField(choices=[('report_datetime', 'Report datetime (visit report)'), ('drawn_datetime', 'Specimen draw date (requisition)')], default='report_datetime', max_length=25)),
                ('reference_model', models.CharField(default='ambition_subject.subjectvisit', editable=False, max_length=150, null=True)),
                ('recipients', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_crfqueryrule_recipients_+', to='edc_data_manager.QueryUser', verbose_name='Send to')),
                ('requisition_panel', models.ForeignKey(blank=True, help_text='Requisition will be expected on day of visit.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_data_manager.RequisitionPanel', verbose_name='Are responses linked to a requisition? If so, which')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_data_manager.DataManagerUser', verbose_name='Query raised by')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
                ('visit_schedule', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_crfqueryrule_visit_schedule_+', to='edc_data_manager.QueryVisitSchedule', verbose_name='Visit')),
                ('visit_schedule_exclude', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_crfqueryrule_visit_schedule_exclude_+', to='edc_data_manager.QueryVisitSchedule', verbose_name='Visit (exclude)')),
                ('data_dictionaries', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_crfqueryrule_data_dictionaries_+', to='edc_data_manager.CrfDataDictionary', verbose_name='Question(s)')),
            ],
            options={
                'abstract': False,
            },
