    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_model', models.CharField(editable=False, max_length=150, null=True)),
                ...
                ('rule_handler_name', models.CharField(blank=True, choices=[('default', 'Default'), ('lumbar_puncture_q13', 'Lumbar Puncture (Q13, 15, 21, 23, 24)')], default='default', max_length=150, null=True)),
                ('reference', models.CharField(db_index=True, default=uuid.uuid4, max_length=36)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locked', models.BooleanField(default=False, help_text='If locked, this query will NEVER be reopened.')),
                ('rule_generated', models.BooleanField(default=False, help_text='This query was auto-generated by a query rule.')),
                ('rule_reference', models.CharField(default=uuid.uuid4, max_length=150, null=True, verbose_name='Query rule reference')),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipients', models.ManyToManyField(blank=True, help_text='Select any additional recipients. Users in the `Site Data Manager` group are automatically included.', related_name='_dataquery_recipients_+', to='edc_data_manager.QueryUser', verbose_name='Sent to')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, null=True)),
                ('recipients', models.ManyToManyField(blank=True, help_text='Select any additional recipients. Users in the `Site Data Manager` group are automatically included.', related_name='_queryrule_recipients_+', to='edc_data_manager.QueryUser', verbose_name='Send to')),
                ('requisition_panel', models.ForeignKey(blank=True, help_text='Requisition will be expected on day of visit.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_data_manager.RequisitionPanel', verbose_name='Are responses linked to a requisition? If so, which')),
                ...
                ('sites', models.ManyToManyField(help_text='Leave blank to apply to all.', to='sites.Site')),
                ('visit_schedule', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_queryrule_visit_schedule_+', to='edc_data_manager.QueryVisitSchedule', verbose_name='Visit')),
                ('visit_schedule_exclude', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_queryrule_visit_schedule_exclude_+', to='edc_data_manager.QueryVisitSchedule', verbose_name='Visit (exclude)')),
                ('data_dictionaries', models.ManyToManyField(blank=True, help_text='select all that apply', related_name='_queryrule_data_dictionaries_+', to='edc_data_manager.CrfDataDictionary', verbose_name='Question(s)')),
            ],
            options={
