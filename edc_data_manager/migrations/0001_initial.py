# Generated by Django 2.2 on 2019-06-04 19:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'New'), ('open', 'Open'), ('feedback', 'Feedback'), ('resolved', 'Resolved'), ('closed', 'Closed')], default='New', max_length=25)),
                ('comment', models.TextField(blank=True, null=True, verbose_name="Data manager's comment")),
                ('response', models.TextField(blank=True, null=True, verbose_name='Clinic / Field comment')),
                ...
                ('registered_subject', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_registration.RegisteredSubject', verbose_name='Subject Identifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', django_audit_fields.fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('title', models.CharField(help_text='Provide a short description of this query', max_length=35)),
                ('query', models.TextField(help_text='Describe the query in detail.')),
                ('comment', models.TextField(blank=True, help_text='Any comment or question from the site or clinic concerning this query ', null=True)),
                ('status', models.CharField(choices=[('open', 'Open'), ('feedback', 'Feedback'), ('closed', 'Closed')], default='open', help_text='Change to CLOSED when all issues related to this query are resolved.', max_length=25)),
                ('field_name', models.CharField(editable=False, max_length=50)),
                ('data_dictionary', models.ManyToManyField(help_text='select all that apply', to='edc_data_manager.DataDictionary', verbose_name='Question(s)')),
                ('data_manager_query', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_data_manager.DataManagerQuery')),
                ('visit_schedule', models.ManyToManyField(help_text='select all that apply', to='edc_data_manager.VisitSchedule', verbose_name='Visit(s)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_subject', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_registration.RegisteredSubject', verbose_name='Subject Identifier')),
